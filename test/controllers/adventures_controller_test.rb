...
class AdventuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post adventures_url, params: { adventure: { backgroud_image: @adventure.backgroud_image, book_name: @adventure.book_name, description: @adventure.description, name: @adventure.name, position: @adventure.position, user_id: @adventure.user_id } }
    end
  ...
  test "should update adventure" do
    patch adventure_url(@adventure), params: { adventure: { backgroud_image: @adventure.backgroud_image, book_name: @adventure.book_name, description: @adventure.description, name: @adventure.name, position: @adventure.position, user_id: @adventure.user_id } }
